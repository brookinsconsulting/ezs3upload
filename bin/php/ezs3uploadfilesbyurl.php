...
$urlsAndNodes = array( 'http://tc/var/cdev_base/storage/images/media/test-image-001/100076-3-eng-GB/test-image-001_large.jpg' => '5160',
                       'http://tc/var/cdev_base/storage/images/media/test-image-001/100076-3-eng-GB/test-image-001_medium.jpg' => '5161',
                       'http://tc/var/cdev_base/storage/images/media/test-image-001/100076-3-eng-GB/test-image-001.jpg' => '5162' );
...
while ( list( $url, $nodeID ) = each( $urlsAndNodes ) )
{
    if( $verbose )
    {
